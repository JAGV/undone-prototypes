...
if ( isset( $_POST['manage_playlist'] ) ){
	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				<a class="wolf-jp-hastip" title="<?php _e( 'Edit playlist', 'wolf' ); ?>" href="<?php echo $edit_link; ?>"><img style="vertical-align:middle; margin-left:10px;" src="<?php echo WOLF_JPLAYER_PLUGIN_URL . '/img/admin/edit.png'; ?>" alt="edit"></a> 
				
				<a class="wolf-jp-hastip" title="<?php _e( 'Delete playlist', 'wolf' ); ?>" href="<?php echo esc_url( admin_url( 'admin.php?page=wolf-jplayer-panel&amp;delete_playlist='.$p->id ) ); ?>" onclick="if ( window.confirm( '<?php _e( 'Are you sure to want to delete this playlist and all songs in it ?', 'wolf'); ?>' ) ) { location.href='default.htm';return true; } else { return false; }"><img style="vertical-align:middle" src="<?php echo WOLF_JPLAYER_PLUGIN_URL . '/img/admin/delete.png'; ?>" alt="delete"></a>
