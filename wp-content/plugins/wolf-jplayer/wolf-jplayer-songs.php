...
<table class="wpw-custom-table">
	...
	<tbody id="sortable">
		...
		<tr class="state-default" id="sortable_<?php echo $s->id; ?>">
			...
			<td><?php echo ( $s->buy) ? $s->buy : '<a class="wolf-jp-hastip" title="' . __( 'Add links where visitors can purchase your song', 'wolf' ) . '" href="' . $edit_link . '">' . __( 'Add an buy links', 'wolf' ) . '</a>';  ?></td>

			<!-- Actions -->
			<td>
				<a href="<?php echo $edit_link; ?>"><img title="<?php _e( 'Edit', 'wolf' ); ?>" class="wolf-jp-hastip" src="<?php echo WOLF_JPLAYER_PLUGIN_URL . '/img/admin/edit.png'; ?>" alt="edit"></a>
				<a onclick="if (window.confirm( '<?php _e( 'Are you sure to want to delete this  song ?', 'wolf' ); ?>' ) ) {location.href='default.htm';return true;} else {return false;}" href="<?php echo $delete_link; ?>"><img title="<?php _e( 'Delete', 'wolf' ); ?>" class="wolf-jp-hastip" src="<?php echo WOLF_JPLAYER_PLUGIN_URL . '/img/admin/delete.png'; ?>" alt="delete"></a>
				<img style="cursor: move" src="<?php echo WOLF_JPLAYER_PLUGIN_URL . '/img/admin/move.png'; ?>" alt="move" title="move">
			</td>
		</tr>
	             <?php endforeach; ?>
	</tbody>
...
<em><?php printf( __( '<a href="%s" target="_blank">How to Increase your Upload Size Limit</a>', 'wolf' ), 'http://wpwolf.com/how-to-increase-your-upload-size-limit/' ); ?></em>
...
<a target="_blank" href="http://wpwolf.com/how-to-increase-your-upload-size-limit/">http://wpwolf.com/how-to-increase-your-upload-size-limit</a>
<?php endif; ?>
